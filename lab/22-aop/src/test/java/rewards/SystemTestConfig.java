...
/**
 * TODO-05: Make this configuration include the aspect configuration. Save all
 * your work, run the LoggingAspectTests. It should pass, and you should see one
 * line of LoggingAspect output in the console.
 */
@Configuration
